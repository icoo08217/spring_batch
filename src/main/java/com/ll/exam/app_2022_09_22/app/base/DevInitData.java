...
public class DevInitData {
    ...
    public CommandLineRunner initData(MemberService memberService , ProductService productService , CartService cartService){
        return args ->
        {
            ...
            cartService.addItem(member1, productOption__RED_44, 1); // productOption__RED__44 총 수량 1
            cartService.addItem(member1, productOption__RED_44, 2); // productOption__RED__44 총 수량 3
            cartService.addItem(member1, productOption__BLUE_44, 1); // productOption__BLUE__44 총 수량 1
